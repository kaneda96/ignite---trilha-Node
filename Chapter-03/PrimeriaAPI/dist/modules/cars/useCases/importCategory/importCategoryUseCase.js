...
var ImportCategoryUseCase = /** @class */ (function () {
    function ImportCategoryUseCase(categoryRepository) {
        this.categoryRepository = categoryRepository;
    }
    ImportCategoryUseCase.prototype.loadCategory = function (file) {
        var _this = this;
    ...
    ImportCategoryUseCase.prototype.execute = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.loadCategory(file)];
                    case 1:
                        categories = _a.sent();
                        categories.map(function (category) {
                            var name = category.name, description = category.description;
                            var categoryAlreadyExists = _this.categoryRepository.findByName(name);
                            if (!categoryAlreadyExists) {
                                _this.categoryRepository.create({ name: name, description: description });
                            }
                        });
                        return [2 /*return*/];
                }
