...
function ensureAuthenticated(request, response, next) {
    return __awaiter(this, void 0, void 0, function () {
        var authHeader, _a, token, userId, userRepository, authUser, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    userId = (0, jsonwebtoken_1.verify)(token, "testeGoku").sub;
                    userRepository = new UserRepository_1.UserRepository();
                    return [4 /*yield*/, userRepository.findById(userId.toString())];
                case 2:
                    authUser = _b.sent();
                    if (!authUser)
