...
var ImportCategoryController = /** @class */ (function () {
    ...
    ImportCategoryController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var file, importCategoriesUseCase, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        file = request.file;
                        importCategoriesUseCase = tsyringe_1.container.resolve(importCategoryUseCase_1.ImportCategoryUseCase);
                        return [4 /*yield*/, importCategoriesUseCase.execute(file)];
                    case 1:
                        _a.sent();
