...
var SpecificationModel_1 = require("../../entities/SpecificationModel");
var database_1 = require("../../../../database");
var SpecificationRepository = /** @class */ (function () {
    function SpecificationRepository() {
        this.specificationRepository = database_1.PostgresDataSource.getRepository(SpecificationModel_1.Specification);
    }
    SpecificationRepository.prototype.findByName = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.specificationRepository.findOne({ where: { name: name } })];
                    case 1:
    ...
    SpecificationRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                specification = new SpecificationModel_1.Specification();
    ...
    SpecificationRepository.prototype.list = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.specificationRepository.find()];
