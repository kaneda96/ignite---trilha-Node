...
var CategoryModel_1 = require("../../entities/CategoryModel");
var index_1 = require("../../../../database/index");
var CategoriesRepository = /** @class */ (function () {
    function CategoriesRepository() {
        this.categoryRepository = index_1.PostgresDataSource.getRepository(CategoryModel_1.Category);
    }
    CategoriesRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        category = new CategoryModel_1.Category();
