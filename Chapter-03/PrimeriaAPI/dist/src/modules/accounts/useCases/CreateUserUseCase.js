...
var CreateUserUseCase = /** @class */ (function () {
    ...
    CreateUserUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var emailAlreadyExists, passwordHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, this.userRepository.create({ name: name, email: email, password: passwordHash, driver_license: driver_license })];
                }
            });
        });
    };
